...
f = plt.figure()
plt.suptitle("Linear/Heading Velocity")
plt.subplot(2, 1, 1)
plt.grid(True)
plt.ylabel("Linear Velocity (m/s)")
plt.plot(x[:,0], x[:,1], color="b", linewidth=2.0, label="LinVel")
plt.legend()
plt.subplot(2, 1, 2)
plt.grid(True)
plt.ylabel("Angular Velocity (rad/s)")
plt.xlabel("Time (s)")
plt.plot(x[:,0], x[:,2], color="b", linewidth=2.0, label="AngVel")
plt.legend()
pw.addPlot("Linear/Heading Velocity", f)
